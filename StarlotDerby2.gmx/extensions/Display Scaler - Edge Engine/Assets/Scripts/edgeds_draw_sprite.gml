///edgeds_draw_sprite(sprite, index, x, y, rot, color, alpha, scale mode, notme);
...
Example usage: edgeds_draw_sprite(spr_mysprite, image_index, 128, 256, 0, c_white, 1, 4, false);
*/
...
if global.display_xscale != 0 and global.display_yscale != 0 {
   ...
   if argument8 == false {
      ...
      image_xscale = sprite_xscale;
      image_yscale = sprite_yscale;
   }
}

//Draw the sprite with the given scaling mode
draw_sprite_ext(argument0,argument1,argument2,argument3,sprite_xscale,sprite_yscale,argument4,argument5,argument6);
