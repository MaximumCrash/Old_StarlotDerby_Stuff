...
view_wport[global.display_view] = (display_width*dpi)/global.display_zoom;
view_hport[global.display_view] = (argument3*dpi)/global.display_zoom; 
...
if global.display_xscale != global.display_xprevscale or global.display_yscale != global.display_yprevscale or global.display_zoom != argument4 {
   ...
   //All platforms
   surface_resize(application_surface, min(display_width, window_width), argument3);
