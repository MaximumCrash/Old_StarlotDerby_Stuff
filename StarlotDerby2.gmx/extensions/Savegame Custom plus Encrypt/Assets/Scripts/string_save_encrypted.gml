...
// Kkys for xor encryption, first byte encrypted by first key, second by second, and so on. You can complicate encryption by adding new keys.
...
for (i=0; i<str_len; i++) { // for every symbol of string
